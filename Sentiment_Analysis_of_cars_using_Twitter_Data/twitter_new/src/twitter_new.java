...
public class twitter_new {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        twitter_new taskObj = new twitter_new();
    ...
    public void loadMenu() throws InterruptedException {
        ...
        while(i < 1)
        {
            ...
            .setOAuthConsumerKey("UUK9jGAf6Y1XkOkaitcYYWeWS")
            .setOAuthConsumerSecret("opFE8dgD7xtoiY1kkrcvNPHSWqDLHqAbdPXD1mXJZljhnx9sAU")
            .setOAuthAccessToken("708530990-uk4oMKB7SNfYl7M7MAaU76v6InEoRP5lBP9ZK93N")
            .setOAuthAccessTokenSecret("iUETCs26EB2JIEysvOu3mhVNNA526lobweWRIPShwythj");
